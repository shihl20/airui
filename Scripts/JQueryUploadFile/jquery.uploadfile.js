...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            duplicateErrorStr: "上传失败. 文件已存在.",
            sizeErrorStr: "上传失败. 超过文件最大限制: ",
            uploadErrorStr: "不允许上传",
            maxFileCountErrorStr: " 上传失败. 超过单次最大上传数:",
            extErrorStr: "不允许上传. 只运行上传以下类型: ",
            downloadStr: "下载",
	...
	this.enqueueFile = function(file){
		...
		function noserializeAndUploadFiles(s, obj, files) {
		    var ts = $.extend({}, s);
                ...
                form.appendTo('body');
                ajaxFormSubmitFile(form, ts, pd, fileArray, obj);
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for(var i = 0; i < files.length; i++) {
                ...
                ajaxFormSubmitFile(form, ts, pd, fileArray, obj, files[i]);
                obj.fileCounter++;
            }
        }
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            fileInput.change(function () {
                ...
                if(s.serialize && feature.fileapi && feature.formdata) //use HTML5 support and split file submission
                {
                    ...
                    ajaxFormSubmitFile(form, s, pd, fileArray, obj, null);
                }
        ...
        function ajaxFormSubmitFile(form, s, pd, fileArray, obj, file) {
            var currentXHR = null;
            var options = {
                cache: false,
                contentType: false,
